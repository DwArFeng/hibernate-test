...
public class XmlSelectDemo {
	...
	public static void main(String[] args) {
		...
		SessionFactory sessionFactory = new Configuration()
				.configure("/com/dwarfeng/test/hibernate/mysql/resources/hibernate.xml-demo.cfg.xml")
				.buildSessionFactory();
		...
		try {
			 ...
			 */
			{
				...
				try {
					 ...
					 * id查询实体，通过反射机制创建实体对象
					 */
					EmpXml empXml = session.get(EmpXml.class, 7369); // 执行查询，get
					tran.commit();// 事务提交
					/*
					 * 在控制台上显示信息。
					 */
